        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body p-0">
                    <div class="card">
                        <form action="{{ route('especialidades.store') }}" method="POST" class="needs-validation" novalidate="">
                            @csrf
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="nombre" class="col-sm-3 col-form-label">Nombre</label>
                                    <div class="col-sm-9">
                                        <input type="text" id="nombre" name="nombre" class="form-control" required="" minlength="3" value="{{ old('nombre') }}">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="selectgroup selectgroup-pills">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="estado" id="estado" value="0" class="selectgroup-input" checked="">
                                                <span class="selectgroup-button selectgroup-button-icon"><i class="fas fa-sun"></i></span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="estado" id="estado" value="1" class="selectgroup-input">
