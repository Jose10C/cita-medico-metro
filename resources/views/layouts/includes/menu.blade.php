<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="#"><i class="far fa-square"></i> <span>Mis Citas</span></a></li>
            <li><a class="nav-link" href="#"><i class="far fa-square"></i> <span>Mis Pacientes</span></a></li>
            @endif
